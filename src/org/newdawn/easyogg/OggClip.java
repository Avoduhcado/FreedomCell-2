...
public class OggClip {
	...
	public void setGain(float gain) {
		...
		try {
			...
			if (gain == -1) {
				...
				float dB = (float) (Math.log10(gain) * 20.0f);
				control.setValue(dB);
			}
	...
	/**
	 * Get the remaining fade time
	 * 
	 * @return remaining fading
	 */
	...
	/**
	 * Change the fade timer
	 * 
	 * @param fade new fade value
	 */
	public void setFading(float fade) {
		this.fading = fade;
		this.fadeStep = fade;
	}
	
	/**
	 * The time to divide delta by to receive new volume increment
	 * 
	 * @return Overall duration of fading
	 */
	...
	public void stop() {
		...
		try {
			...
			System.err.println("Problem stopping audio clip");
		}
	}
