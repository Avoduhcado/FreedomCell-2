...
public class TextureLoader {
	...
	public Texture getSlickTexture(String resourceName) {
		Texture tex = (Texture) table.get(resourceName);
		...
		try {
			...
			try {
				tex = org.newdawn.slick.opengl.TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream(System.getProperty("resources") + "/images/Error.png"));
			} catch(IOException e2) {
				System.err.println("Resource folder may be missing.");
			}
		}
		table.put(resourceName,tex);
	...
	public boolean isTextureReal(String resourceName) {
		Texture tex = (Texture) table.get(resourceName);
	 ...
	 */
	private ByteBuffer convertImageData(BufferedImage bufferedImage, core.render.Texture texture) { 
